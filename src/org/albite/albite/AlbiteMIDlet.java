...
if (DISMISS_COMMAND == null) {//GEN-END:|102-getter|0|102-preInit
            // write pre-init user code here
DISMISS_COMMAND = new Command ("\u79BB\u5F00", Command.OK, 0);//GEN-LINE:|102-getter|1|102-postInit
            // write post-init user code here
...
if (CANCEL_COMMAND == null) {//GEN-END:|118-getter|0|118-preInit
            // write pre-init user code here
CANCEL_COMMAND = new Command ("\u53D6\u6D88", Command.CANCEL, 0);//GEN-LINE:|118-getter|1|118-postInit
            // write post-init user code here
...
if (bookError == null) {//GEN-END:|101-getter|0|101-preInit
            // write pre-init user code here
bookError = new Alert ("\u62B1\u6B49\uFF01", "Sorry, cannot open this book: " + getLoadBook().getTask().getFailureMessage() + ".", null, AlertType.WARNING);//GEN-BEGIN:|101-getter|1|101-postInit
...
if (wordDefinition == null) {//GEN-END:|181-getter|0|181-preInit
            // write pre-init user code here
wordDefinition = new Form ("\u8BCD\u8BED\u5B9A\u4E49", new Item[] { getWordStringItem (), getDefinitionStringItem (), getDictrionaryStringItem () });//GEN-BEGIN:|181-getter|1|181-postInit
...
if (wordStringItem == null) {//GEN-END:|182-getter|0|182-preInit
            // write pre-init user code here
wordStringItem = new StringItem ("\u8BCD", "");//GEN-LINE:|182-getter|1|182-postInit
            // write post-init user code here
...
if (definitionStringItem == null) {//GEN-END:|183-getter|0|183-preInit
            // write pre-init user code here
definitionStringItem = new StringItem ("\u5B9A\u4E49", "");//GEN-LINE:|183-getter|1|183-postInit
            // write post-init user code here
...
if (dictrionaryStringItem == null) {//GEN-END:|184-getter|0|184-preInit
            // write pre-init user code here
dictrionaryStringItem = new StringItem ("\u5B57\u5178", "");//GEN-LINE:|184-getter|1|184-postInit
            // write post-init user code here
...
if (suggestions == null) {//GEN-END:|188-getter|0|188-preInit
            // write pre-init user code here
suggestions = new List ("\u60A8\u7684\u610F\u601D\u662F\uFF1F", Choice.IMPLICIT);//GEN-BEGIN:|188-getter|1|188-postInit
...
if (BACK_COMMAND == null) {//GEN-END:|205-getter|0|205-preInit
            // write pre-init user code here
BACK_COMMAND = new Command ("\u8FD4\u56DE", Command.BACK, 0);//GEN-LINE:|205-getter|1|205-postInit
            // write post-init user code here
...
if (NEXT_COMMAND == null) {//GEN-END:|209-getter|0|209-preInit
            // write pre-init user code here
NEXT_COMMAND = new Command ("\u7EE7\u7EED", Command.OK, 0);//GEN-LINE:|209-getter|1|209-postInit
            // write post-init user code here
...
if (wordBox == null) {//GEN-END:|216-getter|0|216-preInit
            // write pre-init user code here
wordBox = new TextBox ("\u8F93\u5165\u8BCD", "", 100, TextField.ANY);//GEN-BEGIN:|216-getter|1|216-postInit
...
if (CLOSE_COMMAND == null) {//GEN-END:|292-getter|0|292-preInit
            // write pre-init user code here
CLOSE_COMMAND = new Command ("\u5173\u95ED", Command.CANCEL, 0);//GEN-LINE:|292-getter|1|292-postInit
            // write post-init user code here
...
if (numberError == null) {//GEN-END:|316-getter|0|316-preInit
            // write pre-init user code here
numberError = new Alert ("\u62B1\u6B49\uFF01", "\u60A8\u9700\u8981\u8F93\u5165\u4E00\u4E2A\u6570\u5B57\u3002", null, AlertType.ERROR);//GEN-BEGIN:|316-getter|1|316-postInit
...
if (toc == null) {//GEN-END:|325-getter|0|325-preInit
            // write pre-init user code here
toc = new List ("\u76EE\u5F55", Choice.IMPLICIT);//GEN-BEGIN:|325-getter|1|325-postInit
...
if (GO_COMMAND == null) {//GEN-END:|359-getter|0|359-preInit
            // write pre-init user code here
GO_COMMAND = new Command ("\u786E\u5B9A", Command.OK, 0);//GEN-LINE:|359-getter|1|359-postInit
            // write post-init user code here
...
if (chapterPositions == null) {//GEN-END:|354-getter|0|354-preInit
            // write pre-init user code here
chapterPositions = new List ("\u8F6C\u5230\u54EA\u91CC\uFF1F", Choice.IMPLICIT);//GEN-BEGIN:|354-getter|1|354-postInit
chapterPositions.append ("\u6700\u8FD1\u9605\u8BFB", null);
chapterPositions.append ("\u7AE0\u8282\u8D77\u59CB", null);
chapterPositions.append ("\u7AE0\u8282\u672B\u5C3E", null);
chapterPositions.append ("\u6309\u767E\u5206\u6BD4", null);
...
if (__selectedString.equals ("\u6700\u8FD1\u9605\u8BFB")) {//GEN-END:|354-action|1|364-preAction
                // write pre-action user code here
//GEN-LINE:|354-action|2|364-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u7AE0\u8282\u8D77\u59CB")) {//GEN-LINE:|354-action|3|365-preAction
                // write pre-action user code here
//GEN-LINE:|354-action|4|365-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u7AE0\u8282\u672B\u5C3E")) {//GEN-LINE:|354-action|5|366-preAction
                // write pre-action user code here
//GEN-LINE:|354-action|6|366-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u6309\u767E\u5206\u6BD4")) {//GEN-LINE:|354-action|7|608-preAction
                // write pre-action user code here
...
if (acceptLicense == null) {//GEN-END:|372-getter|0|372-preInit
            // write pre-init user code here
acceptLicense = new Form ("\u8BB8\u53EF\u534F\u8BAE", new Item[] { getLicense1 (), getLicense5 (), getLicense13 () });//GEN-BEGIN:|372-getter|1|372-postInit
...
if (license1 == null) {//GEN-END:|373-getter|0|373-preInit
            // write pre-init user code here
license1 = new StringItem ("", "Albite READER \u662F\u7531 Svetlin Ankov \u5F00\u53D1\u7684\u7535\u5B50\u4E66\u9605\u8BFB\u5668\uFF0C\u6309\u7167 Apache 2.0 \u8BB8\u53EF\u534F\u8BAE\u53D1\u5E03\u3002");//GEN-BEGIN:|373-getter|1|373-postInit
...
if (license13 == null) {//GEN-END:|427-getter|0|427-preInit
            // write pre-init user code here
license13 = new StringItem ("", "\u60A8\u63A5\u53D7\u6B64\u8BB8\u53EF\u534F\u8BAE\u5417\uFF1F");//GEN-BEGIN:|427-getter|1|427-postInit
...
if (showLicense == null) {//GEN-END:|428-getter|0|428-preInit
            // write pre-init user code here
showLicense = new Form ("\u5173\u4E8E", new Item[] { getImageItem (), getStringItem (), getStringItem1 (), getStringItem2 (), getStringItem3 () });//GEN-BEGIN:|428-getter|1|428-postInit
...
menu.append ("\u6253\u5F00\u7535\u5B50\u4E66", null);
menu.append ("\u76EE\u5F55", null);
menu.append ("\u4E66\u7B7E", null);
menu.append ("\u56FE\u4E66\u7B80\u4ECB", null);
menu.append ("\u8BBE\u7F6E\u8FDE\u5B57\u7B26", null);
menu.append ("\u8BBE\u7F6E\u7F16\u7801", null);
menu.append ("\u67E5\u627E", null);
menu.append ("\u6570\u503C\u8F6C\u6362", null);
menu.append ("\u5B57\u4F53\u5927\u5C0F", null);
menu.append ("\u5207\u6362\u663C/\u591C\u6A21\u5F0F", null);
menu.append ("\u8BBE\u7F6E\u989C\u8272", null);
menu.append ("\u663E\u793A\u6A21\u5F0F", null);
menu.append ("\u9875\u9762\u4EA4\u4E92", null);
menu.append ("\u9875\u9762\u5E03\u5C40", null);
menu.append ("\u8BBE\u7F6E\u5B57\u5178\u76EE\u5F55", null);
menu.append ("\u5173\u4E8E", null);
menu.append ("\u9000\u51FA", null);
...
if (__selectedString != null) {
if (__selectedString.equals ("\u6253\u5F00\u7535\u5B50\u4E66")) {//GEN-END:|429-action|1|470-preAction
                // write pre-action user code here
openLibrary ();//GEN-LINE:|429-action|2|470-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u76EE\u5F55")) {//GEN-LINE:|429-action|3|469-preAction
                // write pre-action user code here
showToc ();//GEN-LINE:|429-action|4|469-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u4E66\u7B7E")) {//GEN-LINE:|429-action|5|936-preAction
                // write pre-action user code here
                bookCanvas.setupNewBookmark();
switchDisplayable (null, getBookmarks ());//GEN-LINE:|429-action|6|936-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u56FE\u4E66\u7B80\u4ECB")) {//GEN-LINE:|429-action|7|734-preAction
                // write pre-action user code here
showBookInfo ();//GEN-LINE:|429-action|8|734-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u8BBE\u7F6E\u8FDE\u5B57\u7B26")) {//GEN-LINE:|429-action|9|1045-preAction
                // write pre-action user code here
switchDisplayable (null, getLanguages ());//GEN-LINE:|429-action|10|1045-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u8BBE\u7F6E\u7F16\u7801")) {//GEN-LINE:|429-action|11|1046-preAction
                // write pre-action user code here
switchDisplayable (null, getEncodings ());//GEN-LINE:|429-action|12|1046-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u67E5\u627E")) {//GEN-LINE:|429-action|13|471-preAction
                // write pre-action user code here
                setEntryForLookup("");
enterWord ();//GEN-LINE:|429-action|14|471-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u6570\u503C\u8F6C\u6362")) {//GEN-LINE:|429-action|15|472-preAction
                // write pre-action user code here
                setEntryForLookup("");
enterNumber ();//GEN-LINE:|429-action|16|472-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u5B57\u4F53\u5927\u5C0F")) {//GEN-LINE:|429-action|17|473-preAction
                // write pre-action user code here
setFontSize ();//GEN-LINE:|429-action|18|473-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u5207\u6362\u663C/\u591C\u6A21\u5F0F")) {//GEN-LINE:|429-action|19|474-preAction
                // write pre-action user code here
                bookCanvas.cycleColorSchemes();
switchDisplayable (null, bookCanvas);//GEN-LINE:|429-action|20|474-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u8BBE\u7F6E\u989C\u8272")) {//GEN-LINE:|429-action|21|475-preAction
                // write pre-action user code here
setColorScheme ();//GEN-LINE:|429-action|22|475-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u663E\u793A\u6A21\u5F0F")) {//GEN-LINE:|429-action|23|476-preAction
                // write pre-action user code here
setSreenMode ();//GEN-LINE:|429-action|24|476-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u9875\u9762\u4EA4\u4E92")) {//GEN-LINE:|429-action|25|588-preAction
                // write pre-action user code here
setScrollingOptions ();//GEN-LINE:|429-action|26|588-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u9875\u9762\u5E03\u5C40")) {//GEN-LINE:|429-action|27|935-preAction
                // write pre-action user code here
switchDisplayable (null, getPageSettings ());//GEN-LINE:|429-action|28|935-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u8BBE\u7F6E\u5B57\u5178\u76EE\u5F55")) {//GEN-LINE:|429-action|29|477-preAction
                // write pre-action user code here
switchDisplayable (null, getFolderBrowser ());//GEN-LINE:|429-action|30|477-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u5173\u4E8E")) {//GEN-LINE:|429-action|31|478-preAction
                // write pre-action user code here
switchDisplayable (null, getShowLicense ());//GEN-LINE:|429-action|32|478-postAction
                // write post-action user code here
} else if (__selectedString.equals ("\u9000\u51FA")) {//GEN-LINE:|429-action|33|479-preAction
                // write pre-action user code here
...
if (stringItem == null) {//GEN-END:|448-getter|0|448-preInit
            // write pre-init user code here
stringItem = new StringItem ("\u7248\u672C\u53F7\uFF1A", version);//GEN-BEGIN:|448-getter|1|448-postInit
...
if (stringItem1 == null) {//GEN-END:|449-getter|0|449-preInit
            // write pre-init user code here
stringItem1 = new StringItem ("", "Albite READER \u662F\u4E00\u4E2A\u57FA\u4E8E Java ME \u5E73\u53F0\u7684\u514D\u8D39\u7535\u5B50\u4E66\u9605\u8BFB\u5668\uFF0C\u7531 Svetlin Ankov \u5F00\u53D1\u3001taxigps \u6C49\u5316\u3002");//GEN-BEGIN:|449-getter|1|449-postInit
...
if (stringItem2 == null) {//GEN-END:|450-getter|0|450-preInit
            // write pre-init user code here
stringItem2 = new StringItem ("", "\u4F60\u53EF\u4EE5\u4ECE\u4EE5\u4E0B\u7AD9\u70B9\u83B7\u82F1\u6587\u539F\u7248\u7684\u672C\u8F6F\u4EF6\u548C\u514D\u8D39\u7535\u5B50\u4E66\uFF1A");//GEN-BEGIN:|450-getter|1|450-postInit
...
if (APPLY_COMMAND == null) {//GEN-END:|533-getter|0|533-preInit
            // write pre-init user code here
APPLY_COMMAND = new Command ("\u5E94\u7528", Command.OK, 0);//GEN-LINE:|533-getter|1|533-postInit
            // write post-init user code here
...
if (YES_COMMAND == null) {//GEN-END:|548-getter|0|548-preInit
            // write pre-init user code here
YES_COMMAND = new Command ("\u662F", Command.OK, 0);//GEN-LINE:|548-getter|1|548-postInit
            // write post-init user code here
...
if (NO_COMMAND == null) {//GEN-END:|550-getter|0|550-preInit
            // write pre-init user code here
NO_COMMAND = new Command ("\u5426", Command.BACK, 0);//GEN-LINE:|550-getter|1|550-postInit
            // write post-init user code here
...
if (colors == null) {//GEN-END:|530-getter|0|530-preInit
            // write pre-init user code here
colors = new List ("\u8BBE\u7F6E\u989C\u8272", Choice.IMPLICIT);//GEN-BEGIN:|530-getter|1|530-postInit
...
if (unitGroups == null) {//GEN-END:|255-getter|0|255-preInit
            // write pre-init user code here
unitGroups = new List ("\u9009\u62E9\u5355\u4F4D\u7C7B\u578B", Choice.IMPLICIT);//GEN-BEGIN:|255-getter|1|255-postInit
...
if (fontSizes == null) {//GEN-END:|558-getter|0|558-preInit
            // write pre-init user code here
fontSizes = new List ("\u8BBE\u7F6E\u5B57\u4F53\u5927\u5C0F", Choice.IMPLICIT);//GEN-BEGIN:|558-getter|1|558-postInit
...
if (scrollingOptions == null) {//GEN-END:|572-getter|0|572-preInit
            // write pre-init user code here
scrollingOptions = new Form ("\u9875\u9762\u4EA4\u4E92", new Item[] { getScrollingSpeed (), getSmoothScrolling (), getScrollingDirectionGroup (), getHoldingTimeMultiplier () });//GEN-BEGIN:|572-getter|1|572-postInit
...
if (scrollingSpeed == null) {//GEN-END:|582-getter|0|582-preInit
            // write pre-init user code here
scrollingSpeed = new Gauge ("\u6EDA\u52A8\u901F\u5EA6", true, 100, bookCanvas.getScrollingSpeed());//GEN-LINE:|582-getter|1|582-postInit
            // write post-init user code here
...
if (screenModes == null) {//GEN-END:|590-getter|0|590-preInit
            // write pre-init user code here
screenModes = new List ("\u663E\u793A\u6A21\u5F0F", Choice.IMPLICIT);//GEN-BEGIN:|590-getter|1|590-postInit
screenModes.append ("\u6B63\u5E38", null);
screenModes.append ("\u6B63\u5E38\u5168\u5C4F", null);
screenModes.append ("\u987A\u65F6\u9488\u65CB\u8F6C", null);
screenModes.append ("\u4E0A\u4E0B\u5012\u8F6C", null);
screenModes.append ("\u9006\u65F6\u9488\u65CB\u8F6C", null);
...
if (selectPercent == null) {//GEN-END:|609-getter|0|609-preInit
            // write pre-init user code here
selectPercent = new Form ("\u9009\u62E9\u4F4D\u7F6E", new Item[] { getChapterPercent () });//GEN-BEGIN:|609-getter|1|609-postInit
...
if (chapterPercent == null) {//GEN-END:|666-getter|0|666-preInit
            // write pre-init user code here
chapterPercent = new Gauge ("\u7AE0\u8282\u4E2D\u4F4D\u7F6E", true, 100, 0);//GEN-LINE:|666-getter|1|666-postInit
            // write post-init user code here
...
if (RESTART_COMMAND == null) {//GEN-END:|695-getter|0|695-preInit
            // write pre-init user code here
RESTART_COMMAND = new Command ("\u91CD\u542F", Command.SCREEN, 0);//GEN-LINE:|695-getter|1|695-postInit
            // write post-init user code here
...
if (bookInfo == null) {//GEN-END:|724-getter|0|724-preInit
            // write pre-init user code here
bookInfo = new Form ("\u56FE\u4E66\u7B80\u4ECB");//GEN-BEGIN:|724-getter|1|724-postInit
...
if (noDictionaries == null) {//GEN-END:|750-getter|0|750-preInit
            // write pre-init user code here
noDictionaries = new Alert ("\u62B1\u6B49\uFF01", "\u5B57\u5178\u672A\u627E\u5230\u6216\u76EE\u5F55\u672A\u8BBE\u7F6E\u3002", null, AlertType.WARNING);//GEN-BEGIN:|750-getter|1|750-postInit
...
if (dictionaries == null) {//GEN-END:|760-getter|0|760-preInit
            // write pre-init user code here
dictionaries = new List ("\u5B57\u5178", Choice.IMPLICIT);//GEN-BEGIN:|760-getter|1|760-postInit
...
if (dictionaryError == null) {//GEN-END:|771-getter|0|771-preInit
            // write pre-init user code here
dictionaryError = new Alert ("\u62B1\u6B49\uFF01", "\u65E0\u6CD5\u8BFB\u53D6\u5B57\u5178\u3002", null, AlertType.ERROR);//GEN-BEGIN:|771-getter|1|771-postInit
...
if (numberBox == null) {//GEN-END:|245-getter|0|245-preInit
            // write pre-init user code here
numberBox = new TextBox ("\u8F93\u5165\u6570\u5B57", "", 64, TextField.DECIMAL);//GEN-BEGIN:|245-getter|1|245-postInit
...
scanningDictionaries.setText ("\u626B\u63CF\u5B57\u5178...");
...
if (pageSettings == null) {//GEN-END:|878-getter|0|878-preInit
            // write pre-init user code here
pageSettings = new Form ("\u9875\u9762\u5E03\u5C40", new Item[] { getPageMargins (), getLineSpacing (), getReloadImages () });//GEN-BEGIN:|878-getter|1|878-postInit
...
if (pageMargins == null) {//GEN-END:|879-getter|0|879-preInit
            // write pre-init user code here
pageMargins = new Gauge ("\u9875\u8FB9\u8DDD\uFF1A", true, 20, bookCanvas.getCurrentMargin());//GEN-LINE:|879-getter|1|879-postInit
            // write post-init user code here
...
if (lineSpacing == null) {//GEN-END:|880-getter|0|880-preInit
            // write pre-init user code here
lineSpacing = new Gauge ("\u884C\u95F4\u8DDD\uFF1A", true, 10, bookCanvas.getCurrentLineSpacing());//GEN-LINE:|880-getter|1|880-postInit
            // write post-init user code here
...
reloadImages.append ("\u663E\u793A\u4E66\u4E2D\u7684\u56FE\u7247", null);
...
if (bookmarks == null) {//GEN-END:|890-getter|0|890-preInit
            // write pre-init user code here
bookmarks = new List ("\u4E66\u7B7E", Choice.IMPLICIT);//GEN-BEGIN:|890-getter|1|890-postInit
...
if (deleteBookmarkAlert == null) {//GEN-END:|893-getter|0|893-preInit
            // write pre-init user code here
deleteBookmarkAlert = new Alert ("\u786E\u5B9A\u5417\uFF1F", "\u60A8\u8981\u5220\u9664\u6B64\u4E66\u7B7E\u5417\uFF1F", null, AlertType.CONFIRMATION);//GEN-BEGIN:|893-getter|1|893-postInit
...
if (bookmarkText == null) {//GEN-END:|894-getter|0|894-preInit
            // write pre-init user code here
bookmarkText = new TextBox ("\u4E66\u7B7E\u6587\u672C", "", 512, TextField.ANY);//GEN-BEGIN:|894-getter|1|894-postInit
...
if (ADD_COMMAND == null) {//GEN-END:|917-getter|0|917-preInit
            // write pre-init user code here
ADD_COMMAND = new Command ("\u589E\u52A0", Command.SCREEN, 0);//GEN-LINE:|917-getter|1|917-postInit
            // write post-init user code here
...
if (EDIT_COMMAND == null) {//GEN-END:|919-getter|0|919-preInit
            // write pre-init user code here
EDIT_COMMAND = new Command ("\u7F16\u8F91", Command.SCREEN, 0);//GEN-LINE:|919-getter|1|919-postInit
            // write post-init user code here
...
if (DELETE_COMMAND == null) {//GEN-END:|921-getter|0|921-preInit
            // write pre-init user code here
DELETE_COMMAND = new Command ("\u5220\u9664", Command.SCREEN, 0);//GEN-LINE:|921-getter|1|921-postInit
            // write post-init user code here
...
if (noBookmarksFound == null) {//GEN-END:|973-getter|0|973-preInit
            // write pre-init user code here
noBookmarksFound = new Alert ("\u62B1\u6B49\uFF01", "\u8BF7\u5148\u9009\u62E9\u4E00\u4E2A\u4E66\u7B7E\u3002", null, AlertType.WARNING);//GEN-BEGIN:|973-getter|1|973-postInit
...
if (holdingTimeMultiplier == null) {//GEN-END:|1012-getter|0|1012-preInit
            // write pre-init user code here
holdingTimeMultiplier = new Gauge ("\u957F\u6309\u8BA1\u65F6", true, 4, bookCanvas.getHoldingTimeMultiplier() - 1);//GEN-LINE:|1012-getter|1|1012-postInit
            // write post-init user code here
...
if (unitFrom == null) {//GEN-END:|266-getter|0|266-preInit
            // write pre-init user code here
unitFrom = new List ("\u8F6C\u6362\u524D", Choice.IMPLICIT);//GEN-BEGIN:|266-getter|1|266-postInit
...
if (unitTo == null) {//GEN-END:|269-getter|0|269-preInit
            // write pre-init user code here
unitTo = new List ("\u8F6C\u6362\u4E3A", Choice.IMPLICIT);//GEN-BEGIN:|269-getter|1|269-postInit
...
if (exitBox == null) {//GEN-END:|547-getter|0|547-preInit
            // write pre-init user code here
exitBox = new Alert ("\u9000\u51FA", "\u60A8\u786E\u5B9A\u9000\u51FA\u5417\uFF1F", getAlbiteLogo (), AlertType.CONFIRMATION);//GEN-BEGIN:|547-getter|1|547-postInit
...
if (languages == null) {//GEN-END:|1023-getter|0|1023-preInit
            // write pre-init user code here
languages = new List ("\u8BBE\u7F6E\u8FDE\u5B57\u7B26", Choice.IMPLICIT);//GEN-BEGIN:|1023-getter|1|1023-postInit
...
if (encodings == null) {//GEN-END:|1026-getter|0|1026-preInit
            // write pre-init user code here
encodings = new List ("\u8BBE\u7F6E\u7AE0\u8282\u7F16\u7801", Choice.IMPLICIT);//GEN-BEGIN:|1026-getter|1|1026-postInit
...
if (scrollingDirectionGroup == null) {//GEN-END:|1047-getter|0|1047-preInit
            // write pre-init user code here
scrollingDirectionGroup = new ChoiceGroup ("\u6EDA\u52A8\u65B9\u5411", Choice.EXCLUSIVE);//GEN-BEGIN:|1047-getter|1|1047-postInit
scrollingDirectionGroup.append ("\u6C34\u5E73", null);
scrollingDirectionGroup.append ("\u5782\u76F4", null);
...
if (smoothScrolling == null) {//GEN-END:|1050-getter|0|1050-preInit
            // write pre-init user code here
smoothScrolling = new ChoiceGroup ("\u5E73\u6ED1\u6EDA\u52A8", Choice.MULTIPLE);//GEN-BEGIN:|1050-getter|1|1050-postInit
smoothScrolling.append ("\u542F\u7528", null);
...
reflowChapterScreen.setText ("\u7AE0\u8282\u6392\u7248...");
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: ticker ">//GEN-BEGIN:|1093-getter|0|1093-preInit
/**
 * Returns an initiliazed instance of ticker component.
 * @return the initialized component instance
 */
public Ticker getTicker () {
if (ticker == null) {//GEN-END:|1093-getter|0|1093-preInit
 // write pre-init user code here
ticker = new Ticker ("");//GEN-LINE:|1093-getter|1|1093-postInit
 // write post-init user code here
}//GEN-BEGIN:|1093-getter|2|
return ticker;
}
//</editor-fold>//GEN-END:|1093-getter|2|
